...
public class Teste {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		Conduzido3.atualizarDados(Dados.dinheiroCombustivel[8], Dados.nomes[2],Dados.idade[4],Dados.celular[1],Dados.rg[3], Dados.cpf[5],Dados.facebook[2], Dados.LOCALIZACAO_UM.get(2));
		...
		Condutor2.atualizarDados(Dados.CNH[2], new Veiculo(Dados.Placa[1], CorDoCarro.BRANCO, Dados.NumeroDeVagas[3]), Dados.nomes[3], Dados.idade[2], Dados.celular[4], Dados.rg[1], Dados.cpf[3], Dados.facebook[3], Dados.LOCALIZACAO_DOIS);
